<?php $pageTitle = "Paramètres"; $pageCSS = "cv.css"; if(isset($_GET['role']) && $_GET['role']==='entreprise') $userRole = "Entreprise"; ?>
...
<div class="settings-section active" id="tab-general">
  ...
  <div class="settings-card">
    ...
    <div style="display:flex;gap:var(--space-3);flex-wrap:wrap;">
      ...
      <button class="btn btn-ghost" style="color:var(--accent-tertiary);border-color:var(--accent-tertiary);"><i data-lucide="trash-2" style="width:16px;height:16px;"></i> Supprimer mon compte</button>
    </div>
  </div>
</div>
