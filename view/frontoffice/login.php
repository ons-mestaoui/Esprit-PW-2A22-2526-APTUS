  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div class="auth-form" id="login-form">
        ...
        <p class="text-sm text-secondary" style="text-align:center;margin-top:var(--space-4);">Connectez-vous en tant que :</p>
        <div style="display:flex;flex-direction:column;gap:var(--space-3);margin-top:var(--space-3);">
          <a href="jobs_feed.php" class="btn btn-primary btn-lg w-full" style="text-decoration:none;">
            <i data-lucide="user" style="width:18px;height:18px;"></i>
            Candidat
          </a>
          <a href="hr_posts.php" class="btn btn-secondary btn-lg w-full" style="text-decoration:none;">
            <i data-lucide="building-2" style="width:18px;height:18px;"></i>
            Entreprise
          </a>
          <a href="../backoffice/dashboard.php" class="btn btn-lg w-full" style="text-decoration:none;background:var(--bg-tertiary);color:var(--text-primary);border:1px solid var(--border-color);">
