...
$pageTitle = "Candidatures"; $pageCSS = "feeds.css"; $userRole = "Entreprise";
...
$id_entreprise = SessionManager::getUserId();
...
// Récupération des offres de l'entreprise
$listeOffresDisponibles = $offreC->afficherOffres(false, ['id_entreprise' => $id_entreprise]);

$criteres = [];
$criteres['id_entreprise'] = $id_entreprise;
...
<div class="hr-layout" style="grid-template-columns: 300px 1fr;">
  ...
  <div>
    ...
    <div class="candidate-cards-grid stagger" id="candidates-container">
      ...
      ?>
      <div class="candidate-card" id="candidate-<?php echo $idCand; ?>" 
