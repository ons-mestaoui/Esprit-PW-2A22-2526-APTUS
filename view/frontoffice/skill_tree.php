    ...
    <div id="view-timeline">
            ...
            <div class="timeline">
                ...
                <div class="timeline-node">
                    ...
                    <div class="timeline-card">     
                        ...
                        <?php if ($isUnlocked): ?>
                            <a href="formation_detail.php?id=<?php echo $step['id_formation']; ?>" class="btn btn-primary btn-sm">
        ...
        <?php elseif ($viewMode === 'all' && !empty($allTrees)): ?>
            ...
            <?php foreach ($allTrees as $tree): ?>
                <div style="background: var(--bg-card); border: 1px solid var(--border-color); border-radius: 16px; padding: 1.5rem;" class="card-formation-hover">
                    <h4 style="font-size: 0.75rem; color: <?php echo $tree['root']['lieu_color'] ?? 'var(--primary-cyan)'; ?>; text-transform: uppercase; margin-bottom: 1rem; font-weight: 800; display: flex; align-items: center; gap: 0.4rem;">
                    ...
                    <div style="background: var(--bg-secondary); border-radius: 12px; padding: 1rem; margin-bottom: 1.5rem;">
                        <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem;">
                            ...
                            ?>
                            <li style="font-size: 0.85rem; color: <?php echo $isDone ? '#10b981' : ($node['is_unlocked'] ? '#0ea5e9' : '#475569'); ?>; display: flex; align-items: center; gap: 0.5rem;">
                                <i data-lucide="<?php echo $isDone ? 'check-circle-2' : ($node['is_unlocked'] ? 'circle' : 'lock'); ?>" style="width: 14px; height: 14px;"></i>
