            ...
            const widgetHTML = `
                <div id="ai-agent-widget" class="state-idle power-off dock-right">
                    <div class="ai-controls">
                        ...
                        <input type="text" id="ai-text-input" placeholder="Tapez ici..." style="border:1px solid #e5e7eb; border-radius:12px; padding:4px 8px; font-size:12px; width:120px; outline:none; display:none; color: #000 !important; background-color: #fff !important;">
